...
class TweetDetailViewModel(private val tweetDetail: TweetDetail, private val repository: TweetRepository) :
    ViewModel() {
    ...
    val coordinates =
        if (tweetDetail.latitude == null || tweetDetail.longitude == null) "" else "${tweetDetail.latitude}, ${tweetDetail.longitude}"
